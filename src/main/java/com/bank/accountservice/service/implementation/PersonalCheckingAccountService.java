...
@Service
public class PersonalCheckingAccountService implements AccountService<PersonalCheckingAccountRequest> {
    private final CheckingAccountRepository repository;
    private final AccountMapper mapper;

    @Override
    public Mono<OperationResponse> save(PersonalCheckingAccountRequest request) {
